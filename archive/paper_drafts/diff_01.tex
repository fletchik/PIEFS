...
%DIF DEL main.tex      Thu May  7 18:48:00 2026
%DIF ADD main_v0.tex   Thu May  7 18:49:26 2026
...
%DIF < 
%DIF < \author{Alexander Tarakanov HSE, VK \thanks{ Higher School of Economics \\
%DIF < Faculty of Computer Science , Moscow, Russia\\
%DIF < VK, Research Division, Moscow, Russia\\
%DIF < \texttt{\{atarakanov\}@hse.ru} \\}
%DIF < \And
%DIF < Timur Lidzhiev, HSE \thanks{Higher School of Economics \\
%DIF < Faculty of Computer Science , Moscow, Russia \\
%DIF < \texttt{\{trlidzhiev\}@gmail.com} \\
%DIF < }
%DIF < }
%DIF DELETED TITLE COMMANDS FOR MARKUP
\author{\DIFdelbegin \DIFdel{Alexander Tarakanov HSE, VK }%DIFDELCMD < \thanks{ Higher School of Economics \\
%DIFDELCMD < Faculty of Computer Science , Moscow, Russia\\
%DIFDELCMD < VK, Research Division, Moscow, Russia\\
%DIFDELCMD < \texttt{\{atarakanov\}@hse.ru} \\}
%DIFDELCMD < \And
%DIFDELCMD < %%%
\DIFdel{Timur Lidzhiev, HSE }%DIFDELCMD < \thanks{Higher School of Economics \\
%DIFDELCMD < Faculty of Computer Science , Moscow, Russia \\
%DIFDELCMD < \texttt{\{trlidzhiev\}@gmail.com} \\
%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelend }%DIFAUXCMD
...
%DIFDELCMD <   \icmltitle{Submission and Formatting Instructions for \\
%DIFDELCMD <     AI4Physics Workshop @ ICML 2026}
%DIFDELCMD < 
...
%DIFDELCMD <     \icmlauthor{Varvara Nazarenko}{equal,HSE}
%DIFDELCMD <     \icmlauthor{Alexander Tarakanov}{equal,HSE, VK}
%DIFDELCMD <   \end{icmlauthorlist}
%DIFDELCMD < 

%DIFDELCMD <   \icmlaffiliation{HSE}{Faculty of Computer Science, Higher School of Economics, Moscow, Russia}
%DIFDELCMD <   \icmlaffiliation{VK}{VK, Moscow, RUssia}
%DIFDELCMD <   

%DIFDELCMD <   \icmlcorrespondingauthor{Varvara Nazarenko}{varunaza@gmail.com}
%DIFDELCMD <   \icmlcorrespondingauthor{Alexander Tarakanov}{atarakanov@hse.ru}
%DIFDELCMD < 
...
%DIFDELCMD <   \icmlkeywords{Machine Learning, Physics Informed Neural Networks, Feature Engineering, ICML}
%DIFDELCMD < 
...
\DIFadd{Simple modification to illustrate how file difference works.
}\DIFaddend 
